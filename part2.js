        ...
        for (let i = 0; i < quantity; i++) {
            ...
            while (!placeShip) {
                ...
                while (!coordinatesAvailable) {
                    shipCoordinates = String.fromCharCode(97 + getRandomInt(unitGridY)) + (getRandomInt(unitGridX) + 1);
